...
\captionof{figure}{Prolétaires (bleu, unité $\chi_M$), ressources naturelles (vert, unité $\lambda$) et richesses accumulées (gris, unité 20 $\lambda$), pour une société "egalitarian" dans la configuration "irreversible type-N collapse". La variable "ressources naturelles" devient négative au pas de temps 323, ce qui n'a plus de sens. \label{fig:egalitarian-collapse-fe-01-lpos1-sp}}
\end{center}
